...
TEST(scatter_nd_update_gpu_fp16_kelvin3, data3_indice1_update3) {
    engine engine;
...
TEST(scatter_nd_update_gpu_fp16_kelvin2, data2_indice1_update2) {
    engine engine;
...
TEST(scatter_nd_update_gpu_fp16_kelvin1, data1_indice1_update1) {
    engine engine;
